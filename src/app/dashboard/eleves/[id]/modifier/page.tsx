...
export default async function ModifierElevePage({ params }: { params: { id: string } }) {
  ...
  if (!student) {
    return (
      <div className="page">
        <div className="error-box">Élève introuvable.</div>
      </div>
    );
  }
